...
public class NoticeHodAdapter extends FirebaseRecyclerAdapter<NoticeData,NoticeHodAdapter.myviewholder> {

    public NoticeHodAdapter(@NonNull FirebaseRecyclerOptions<NoticeData> options)
    {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final NoticeHodAdapter.myviewholder holder, @SuppressLint("RecyclerView") final int position, @NonNull final NoticeData NoticeData)
    {
    ...
    @NonNull
    @Override
    public NoticeHodAdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.singlenotice,parent,false);
        return new NoticeHodAdapter.myviewholder(view);
    }
